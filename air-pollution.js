...
const setValuesOfAir = airData => {
	...
	// Display real AQI value
	document.querySelector('.aqi-value').innerText = aqi;
...
//     });
// Inside the setValuesOfAir function, after setting airQualityStat and color
// const realAQIValue = airData.list[0].main.aqi;
// document.querySelector('.aqi-value').innerText = realAQIValue;

// Inside the getAirQuality function, after setting components of air
